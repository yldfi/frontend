                    ...
                    <div className="flex items-center gap-2.5 mb-4">
                      {vault.badges?.map((badge) => (
                        badge === "Collateral (LlamaLend)" ? (
                          ...
                          <span key={badge} className={`inline-flex items-center px-2 py-1 text-[11px] font-medium bg-[var(--muted)] text-white rounded border border-transparent whitespace-nowrap${badge === "Compounder" ? " hidden lg:inline-flex" : ""}`}>
                            {badge}
                          </span>
                        )
                      ))}
                        ...
                        <div className="flex items-center gap-2.5 mt-1">
                          {vault.badges?.map((badge) => (
                            badge === "Collateral (LlamaLend)" ? (
                              ...
                              <span key={badge} className={`inline-flex items-center px-1.5 py-0.5 text-xs font-medium bg-[var(--muted)] text-white rounded border border-transparent whitespace-nowrap${badge === "Compounder" ? " hidden lg:inline-flex" : ""}`}>
                                {badge}
                              </span>
                            )
                          ))}
